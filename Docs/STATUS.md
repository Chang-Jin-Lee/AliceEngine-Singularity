...
| Runtime 설계 | World·컴포넌트 등록·렌더 패킷·규칙 실행 공개 헤더, 컴파일 검사 | `Engine/Runtime/`, [아키텍처](ARCHITECTURE.md#runtime-contract) |
...
| 영역 | 남은 작업 | 백로그 |
|---|---|---|
| Runtime | 공개 인터페이스는 작성됨. ECS, 씬 로딩, 규칙 실행, 상태 덤프, 프레임 루프 구현이 남음 | [ALI-02](../Agents/Backlog/alice/ALI-02.md), [Sidney](../Agents/Backlog/sidney/) |
