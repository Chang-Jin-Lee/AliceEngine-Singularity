---
title: 현재 실행 상태와 개발 순서
synced: Docs/STATUS.md
order: 1
---
...
| Runtime ECS | World·컴포넌트 등록·연속 저장·질의·지연 파괴·읽기 가드 구현 | `Engine/Runtime/ECS/`, `Alice.Tests`, [아키텍처](/guide/architecture/#runtime-contract) |
...
| 영역 | 남은 작업 | 백로그 |
|---|---|---|
| Runtime | ECS 구현됨. 씬 로딩, 규칙 실행, 상태 덤프, 프레임 루프 구현이 남음 | [Sidney](https://github.com/Chang-Jin-Lee/AliceEngine-Singularity/tree/main/Agents/Backlog/sidney/) |
